...
\title{Senior (DevOps|Site Reliability|Software) Engineer}
...
\begin{document}
    ...
    Contributions:
        \begin{itemize}
            ...
            \item Contributed to an Airflow-based solution for packaging, scheduling and monitoring ETL pipelines;
...
% \hfill\break
    ...
    \section{Awards \& achievments}\label{sec:awards-achievments}
