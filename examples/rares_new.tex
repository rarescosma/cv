...
\photo[64pt][0.4pt]{examples/picture_forest}                       % optional, remove / comment the line if not wanted; '64pt' is the height the picture must be resized to, 0.4pt is the thickness of the frame around it (put it to 0pt for no frame) and 'picture' is the name of the picture file
...
%-----       resume       ---------------------------------------------------------
    ...
    Contributions:
        \begin{itemize}
            ...
            \item Contributed to an Airflow-based solution for packaging, scheduling and monitoring ETL transformations;
